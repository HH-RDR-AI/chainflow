...
// File: contracts/PicCraftNFT.sol
...
contract PicCraftNFT is ERC721Enumerable {
    using Strings for uint256;
    ...
    function _baseURI() internal view virtual override returns (string memory) {
        return "https://api.piccraft.xyz/artsworks/nft/";
    }
    ...
    function mint(bytes32[] memory merkleProof) public payable {
        ...
        if (isUserWhitelisted) {
            ...
            revert("Account is not eligible for minting");
        }
    }
