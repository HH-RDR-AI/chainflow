...
class GetProfile(chainflow_pycamunda.base.CamundaRequest):
...
class UpdateCredentials(chainflow_pycamunda.base.CamundaRequest):
...
class UpdateProfile(chainflow_pycamunda.base.CamundaRequest):
