...
from chainflow_pycamunda.request import BodyParameter, PathParameter, QueryParameter
...
__all__ = [
    ...
    'Delegate', 'Create', 'Update', 'LocalVariablesGet', 'LocalVariablesGetList', 'VariablesGetList',
...
class Task:
    ...
    def load(cls, data: typing.Mapping[str, typing.Any]) -> Task:
        ...
        if data['created'] is not None:
            task.created = chainflow_pycamunda.base.from_isoformat(data['created'])
        if data['due'] is not None:
            task.due = chainflow_pycamunda.base.from_isoformat(data['due'])
        if data['followUp'] is not None:
            task.follow_up = chainflow_pycamunda.base.from_isoformat(data['followUp'])
...
class Comment:
    ...
    def load(cls, data: typing.Mapping[str, typing.Any]) -> Comment:
        ...
        if data['time'] is not None:
            comment.time = chainflow_pycamunda.base.from_isoformat(data['time'])
        if data['removalTime'] is not None:
            comment.removal_time = chainflow_pycamunda.base.from_isoformat(data['removalTime'])
...
class Get(chainflow_pycamunda.base.CamundaRequest):
...
class GetList(chainflow_pycamunda.base.CamundaRequest):
    ...
    with_candidate_groups = QueryParameter(
        'withCandidateGroups', provide=chainflow_pycamunda.base.value_is_true
    )
    without_candidate_groups = QueryParameter(
        'withoutCandidateGroups', provide=chainflow_pycamunda.base.value_is_true
    )
    with_candidate_users = QueryParameter(
        'withCandidateUsers', provide=chainflow_pycamunda.base.value_is_true
    )
    without_candidate_users = QueryParameter(
        'withoutCandidateUsers', provide=chainflow_pycamunda.base.value_is_true
    )
...
class Claim(chainflow_pycamunda.base.CamundaRequest):
...
class Unclaim(chainflow_pycamunda.base.CamundaRequest):
...
class Complete(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(
        self, *args, **kwargs
    ) -> typing.Optional[typing.Dict[str, chainflow_pycamunda.variable.Variable]]:
        """Send the request."""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.POST, *args, **kwargs)

        if self.with_variables_in_return:
            return {
                name: chainflow_pycamunda.variable.Variable.load(var_json)
                for name, var_json in response.json().items()
            }


class Resolve(chainflow_pycamunda.base.CamundaRequest):
...
class SetAssignee(chainflow_pycamunda.base.CamundaRequest):
...
class Delegate(chainflow_pycamunda.base.CamundaRequest):
...
class Create(chainflow_pycamunda.base.CamundaRequest):
...
class Update(chainflow_pycamunda.base.CamundaRequest):
...
class IdentityLinksGetList(chainflow_pycamunda.base.CamundaRequest):
...
class IdentityLinksAdd(chainflow_pycamunda.base.CamundaRequest):
...
class IdentityLinksDelete(chainflow_pycamunda.base.CamundaRequest):
...
class CommentGetList(chainflow_pycamunda.base.CamundaRequest):
...
class CommentGet(chainflow_pycamunda.base.CamundaRequest):
...
class CommentCreate(chainflow_pycamunda.base.CamundaRequest):
...
class LocalVariablesGet(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> chainflow_pycamunda.variable.Variable:
        """Send the request."""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.GET, *args, **kwargs)

        if self.binary:
            return response.content
        return chainflow_pycamunda.variable.Variable.load(data=response.json())


class VariablesGetList(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> typing.Dict[str, chainflow_pycamunda.variable.Variable]:
        """Send the request."""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.GET, *args, **kwargs)

        return {
            name: chainflow_pycamunda.variable.Variable.load(data=var_json)
            for name, var_json in response.json().items()
        }


class LocalVariablesGetList(chainflow_pycamunda.base.CamundaRequest):
...
class LocalVariablesModify(chainflow_pycamunda.base.CamundaRequest):
...
class LocalVariablesUpdate(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> None:
        ...
        if self._is_binary():
            ...
            response = super().__call__(chainflow_pycamunda.base.RequestMethod.PUT, *args, **kwargs)

        if not response:
            chainflow_pycamunda.base._raise_for_status(response)


class LocalVariablesDelete(chainflow_pycamunda.base.CamundaRequest):
...
class GetCountByCandidateGroup(chainflow_pycamunda.base.CamundaRequest):
