...
import chainflow_pycamunda.caseinst
...
class GetDiagram(chainflow_pycamunda.base._PathMixin, chainflow_pycamunda.base.CamundaRequest):
...
class CreateInstance(chainflow_pycamunda.base._PathMixin, chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> chainflow_pycamunda.caseinst.CaseInstance:
        """Send the request."""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.POST, *args, **kwargs)

        return chainflow_pycamunda.caseinst.CaseInstance.load(response.json())
