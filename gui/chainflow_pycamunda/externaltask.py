...
class ExternalTask:
    ...
    def load(cls, data: typing.Mapping[str, typing.Any]) -> ExternalTask:
        ...
        if data['lockExpirationTime'] is not None:
            external_task.lock_expiration_time = chainflow_pycamunda.base.from_isoformat(
        ...
        try:
            ...
            external_task.variables = {
                var_name: chainflow_pycamunda.variable.Variable(
...
class GetList(chainflow_pycamunda.base.CamundaRequest):
    ...
    locked = QueryParameter('locked', provide=chainflow_pycamunda.base.value_is_true)
    not_locked = QueryParameter('notLocked', provide=chainflow_pycamunda.base.value_is_true)
    with_retries_left = QueryParameter('withRetriesLeft', provide=chainflow_pycamunda.base.value_is_true)
    no_retries_left = QueryParameter('noRetriesLeft', provide=chainflow_pycamunda.base.value_is_true)
    ...
    def query_parameters(self, apply: typing.Callable = ...):
        ...
        for key, value in params.items():
            if isinstance(value, dt.datetime):
                params[key] = chainflow_pycamunda.base.isoformat(datetime_=value)
        return params
    ...
    def __call__(self, *args, **kwargs) -> int:
        ...
        try:
            response = requests.request(
                method=chainflow_pycamunda.base.RequestMethod.GET.value,
                url=self.url,
...
class FetchAndLock(chainflow_pycamunda.base.CamundaRequest):
...
class HandleBPMNError(chainflow_pycamunda.base.CamundaRequest):
...
class HandleFailure(chainflow_pycamunda.base.CamundaRequest):
...
class Unlock(chainflow_pycamunda.base.CamundaRequest):
...
class ExtendLock(chainflow_pycamunda.base.CamundaRequest):
...
class SetPriority(chainflow_pycamunda.base.CamundaRequest):
...
class SetRetries(chainflow_pycamunda.base.CamundaRequest):
...
class SetRetriesAsync(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> chainflow_pycamunda.batch.Batch:
        """Send the request"""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.POST, *args, **kwargs)
...
class SetRetriesSync(chainflow_pycamunda.base.CamundaRequest):
