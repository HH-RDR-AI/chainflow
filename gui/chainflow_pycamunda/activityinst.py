...
class TransitionInstance:
    ...
    incidents: typing.Tuple[chainflow_pycamunda.incident.IncidentTypeCount]
    ...
    def load(cls, data: typing.Mapping[str, typing.Any]) -> TransitionInstance:
        return cls(
            ...
            incidents=tuple(
                chainflow_pycamunda.incident.IncidentTypeCount.load(incident_json)
...
class ActivityInstance:
    ...
    incidents: typing.Tuple[chainflow_pycamunda.incident.IncidentTypeCount] = None
