...
class UsersGroups:
    ...
    Camunda."""
    groups: typing.Tuple[chainflow_pycamunda.group.Group]
    group_users: typing.Tuple[chainflow_pycamunda.user.User]

    @classmethod
    def load(cls, data: typing.Mapping[str, typing.Any]) -> UsersGroups:
        return cls(
            groups=tuple(chainflow_pycamunda.group.Group.load(group) for group in data['groups']),
            group_users=tuple(chainflow_pycamunda.user.User.load(user) for user in data['groupUsers'])
        )
...
class GetGroups(chainflow_pycamunda.base.CamundaRequest):
...
class VerifyUser(chainflow_pycamunda.base.CamundaRequest):
...
class GetPasswordPolicy(chainflow_pycamunda.base.CamundaRequest):
...
class ValidatePassword(chainflow_pycamunda.base.CamundaRequest):
