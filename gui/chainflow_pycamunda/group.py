...
class Delete(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> None:
        """Send the request."""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.DELETE, *args, **kwargs)


class MemberCreate(chainflow_pycamunda.base.CamundaRequest):
...
class MemberDelete(chainflow_pycamunda.base.CamundaRequest):
...
class MemberOptions(chainflow_pycamunda.base.CamundaRequest):
