...
class Delete(chainflow_pycamunda.base.CamundaRequest):
    ...
    id_ = PathParameter('id')
    cascade = QueryParameter('cascade', provide=chainflow_pycamunda.base.value_is_true)
...
class GetStats(chainflow_pycamunda.base.CamundaRequest):
...
class CountStats(chainflow_pycamunda.base.CamundaRequest):
