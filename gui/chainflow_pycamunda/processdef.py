...
import chainflow_pycamunda.batch
import chainflow_pycamunda.incident
import chainflow_pycamunda.instruction
import chainflow_pycamunda.base
from chainflow_pycamunda.request import QueryParameter, PathParameter, BodyParameter, BodyParameterContainer
...
class ActivityStats:
    ...
    instances: int
    failed_jobs: int
    incidents: typing.Iterable[chainflow_pycamunda.incident.IncidentTypeCount]
    ...
    def load(cls, data: typing.Mapping[str, typing.Any]) -> ActivityStats:
        return cls(
            ...
            incidents=tuple(
                chainflow_pycamunda.incident.IncidentTypeCount.load(incident_data)
...
class GetActivityInstanceStats(chainflow_pycamunda.base._PathMixin, chainflow_pycamunda.base.CamundaRequest):
    ...
    incidents = QueryParameter('incidents', provide=chainflow_pycamunda.base.value_is_true)
    ...
    def __init__(
        ...
        incidents_for_type: typing.Union[str, chainflow_pycamunda.incident.IncidentType] = None
    ):
        ...
        if incidents and incidents_for_type is not None:
            raise chainflow_pycamunda.PyCamundaException(
        ...
        if incidents_for_type is not None:
            self.incidents_for_type = chainflow_pycamunda.incident.IncidentType(incidents_for_type)
...
class GetProcessDiagram(chainflow_pycamunda.base._PathMixin, chainflow_pycamunda.base.CamundaRequest):
...
class Count(chainflow_pycamunda.base.CamundaRequest):
    ...
    latest_version = QueryParameter('latestVersion', provide=chainflow_pycamunda.base.value_is_true)
    ...
    active = QueryParameter('active', provide=chainflow_pycamunda.base.value_is_true)
    suspended = QueryParameter('suspended', provide=chainflow_pycamunda.base.value_is_true)
    ...
    without_tenant_id = QueryParameter('withoutTenantId', provide=chainflow_pycamunda.base.value_is_true)
    include_without_tenant_id = QueryParameter(
        'includeProcessDefinitionsWithoutTenantId',
        provide=chainflow_pycamunda.base.value_is_true
    )
    ...
    def __init__(
        ...
        incident_type: typing.Union[str, chainflow_pycamunda.incident.IncidentType] = None,
        ...
        if incident_type is not None:
            self.incident_type = chainflow_pycamunda.incident.IncidentType(incident_type)
...
class GetList(chainflow_pycamunda.base.CamundaRequest):
...
class GetProcessInstanceStats(chainflow_pycamunda.base.CamundaRequest):

    failed_jobs = QueryParameter('failedJobs')
    incidents = QueryParameter('incidents', provide=chainflow_pycamunda.base.value_is_true)
    root_incidents = QueryParameter('rootIncidents', provide=chainflow_pycamunda.base.value_is_true)
    incidents_for_type = QueryParameter('incidentsForType')
...
class GetXML(chainflow_pycamunda.base._PathMixin, chainflow_pycamunda.base.CamundaRequest):
...
class Get(chainflow_pycamunda.base._PathMixin, chainflow_pycamunda.base.CamundaRequest):
...
class StartInstance(chainflow_pycamunda.base._PathMixin, chainflow_pycamunda.base.CamundaRequest):
    ...
    def __init__(
        ...
        if id_ is not None and key is not None:
            raise chainflow_pycamunda.PyCamundaException('Either `id_ or `key` can be provided, not both.')
    ...
    def _add_start_instruction(
        self,
        type_: typing.Union[str, chainflow_pycamunda.instruction.InstructionType],
        activity_id: str = None,
        transition_id: str = None,
        variables: typing.Mapping[str, chainflow_pycamunda.variable.Variable] = None
    ) -> None:
        ...
        :return:
        """
        instruction = {'type': chainflow_pycamunda.instruction.InstructionType(type_).value}
    ...
    def add_start_before_activity_instruction(
        ...
        self._add_start_instruction(
            type_=chainflow_pycamunda.instruction.InstructionType.start_before_activity,
            activity_id=id_,
            variables=variables
        )
    ...
    def add_start_after_activity_instruction(
        ...
        """
        self._add_start_instruction(
            type_=chainflow_pycamunda.instruction.InstructionType.start_after_activity,
            activity_id=id_,
            variables=variables
        )
    ...
    def add_start_transition_instruction(
        ...
        """
        self._add_start_instruction(
            type_=chainflow_pycamunda.instruction.InstructionType.start_transition,
            transition_id=id_,
            variables=variables
        )

    def __call__(self, *args, **kwargs) -> chainflow_pycamunda.processinst.ProcessInstance:
        """Send the request."""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.POST, *args, **kwargs)

        return chainflow_pycamunda.processinst.ProcessInstance.load(response.json())


class _ActivateSuspend(chainflow_pycamunda.base._PathMixin, chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> None:
        """Send the request."""
        super().__call__(chainflow_pycamunda.base.RequestMethod.PUT, *args, **kwargs)
...
class UpdateHistoryTimeToLive(chainflow_pycamunda.base._PathMixin, chainflow_pycamunda.base.CamundaRequest):
...
class Delete(chainflow_pycamunda.base._PathMixin, chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> None:
        """Send the request."""
        super().__call__(chainflow_pycamunda.base.RequestMethod.DELETE, *args, **kwargs)


class RestartProcessInstance(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> typing.Optional[chainflow_pycamunda.batch.Batch]:
        """Send the request."""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.POST, *args, **kwargs)

        if self.async_:
            return chainflow_pycamunda.batch.Batch.load(response.json())
