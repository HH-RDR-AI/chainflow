...
class Authorization:
    ...
    user_id: str
    group_id: str
    resource_type: chainflow_pycamunda.resource.ResourceType
    resource_id: str
    links: typing.Tuple[chainflow_pycamunda.resource.Link] = None
    ...
    def load(cls, data: typing.Mapping[str, typing.Any]) -> Authorization:
        authorization = cls(
            ...
            resource_type=chainflow_pycamunda.resource.ResourceType(data['resourceType']),
            resource_id=data['resourceId']
        )
        try:
            authorization.links = tuple(
                chainflow_pycamunda.resource.Link.load(data=link) for link in data['links']
            )
        except KeyError:
            pass
        try:
            authorization.removal_time = chainflow_pycamunda.base.from_isoformat(data['removalTime'])
        except KeyError:
            pass
        try:
...
class GetList(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __init__(
        ...
        resource_type: typing.Union[str, chainflow_pycamunda.resource.ResourceType] = None,
        ...
        if type_ is not None:
            self.resource_type = chainflow_pycamunda.resource.ResourceType(resource_type)
...
class Check(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __init__(
        ...
        resource_name: str,
        resource_type: typing.Union[str, chainflow_pycamunda.resource.ResourceType],
...
class Options(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> chainflow_pycamunda.resource.ResourceOptions:
        """Send the request."""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.OPTIONS, *args, **kwargs)

        return chainflow_pycamunda.resource.ResourceOptions.load(data=response.json())
