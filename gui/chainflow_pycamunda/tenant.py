...
class UserMemberCreate(chainflow_pycamunda.base.CamundaRequest):
...
class UserMemberDelete(chainflow_pycamunda.base.CamundaRequest):
...
class UserMemberOptions(chainflow_pycamunda.base.CamundaRequest):
...
class GroupMemberCreate(chainflow_pycamunda.base.CamundaRequest):
...
class GroupMemberDelete(chainflow_pycamunda.base.CamundaRequest):
...
class GroupMemberOptions(chainflow_pycamunda.base.CamundaRequest):
