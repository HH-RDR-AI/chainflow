...
class Generate(chainflow_pycamunda.base.CamundaRequest):
...
class Validate(chainflow_pycamunda.base.CamundaRequest):
...
class Execute(chainflow_pycamunda.base.CamundaRequest):
