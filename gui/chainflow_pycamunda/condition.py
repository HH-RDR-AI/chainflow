...
class Evaluate(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> typing.Tuple[chainflow_pycamunda.processinst.ProcessInstance]:
        """Send the request."""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.POST, *args, **kwargs)

        return tuple(
            chainflow_pycamunda.processinst.ProcessInstance.load(data=result_json)
