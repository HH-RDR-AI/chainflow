...
import chainflow_pycamunda.activityinst
...
from chainflow_pycamunda.request import QueryParameter, PathParameter, BodyParameter
...
class ProcessInstance:
    ...
    tenant_id: str
    suspended: bool
    links: typing.Tuple[chainflow_pycamunda.resource.Link]
    variables: typing.Dict[str, chainflow_pycamunda.variable.Variable] = None
    ...
    def load(cls, data: typing.Mapping[str, typing.Any]) -> ProcessInstance:
        process_instance = cls(
            ...
            links=tuple(chainflow_pycamunda.resource.Link.load(link_json) for link_json in data['links']),
        )
        try:
            ...
            process_instance.variables = {name: chainflow_pycamunda.variable.Variable.load(var_json)
                                          for name, var_json in variables.items()}

        return process_instance


class Delete(chainflow_pycamunda.base.CamundaRequest):
...
class GetActivityInstance(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> chainflow_pycamunda.activityinst.ActivityInstance:
        """Send the request."""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.GET, *args, **kwargs)

        return chainflow_pycamunda.activityinst.ActivityInstance.load(response.json())
...
class Modify(chainflow_pycamunda.base.CamundaRequest):
    ...
    def _add_instruction(
        self,
        type_: typing.Union[str, chainflow_pycamunda.instruction.ModifyInstructionType],
        ...
        """
        instruction = {'type': chainflow_pycamunda.instruction.ModifyInstructionType(type_).value}
    ...
    def add_before_activity_instruction(
        ...
        self._add_instruction(
            type_=chainflow_pycamunda.instruction.ModifyInstructionType.start_before_activity,
            activity_id=id_,
            variables=variables
        )
    ...
    def add_after_activity_instruction(
        ...
        """
        self._add_instruction(
            type_=chainflow_pycamunda.instruction.ModifyInstructionType.start_after_activity,
            activity_id=id_,
            variables=variables
        )
    ...
    def add_cancel_activity_instruction(self, id_) -> None:
        ...
        """
        self._add_instruction(
            type_=chainflow_pycamunda.instruction.ModifyInstructionType.cancel,
            activity_id=id_
        )
    ...
    def add_transition_instruction(
        ...
        """
        self._add_instruction(
            type_=chainflow_pycamunda.instruction.ModifyInstructionType.start_transition,
            transition_id=id_,
            variables=variables
        )
...
class _ActivateSuspend(chainflow_pycamunda.base.CamundaRequest):
...
class VariablesDelete(chainflow_pycamunda.base.CamundaRequest):
...
class VariablesGet(chainflow_pycamunda.base.CamundaRequest):
    ...
    def __call__(self, *args, **kwargs) -> typing.Union[chainflow_pycamunda.variable.Variable, bytes]:
        """Send the request."""
        response = super().__call__(chainflow_pycamunda.base.RequestMethod.GET, *args, **kwargs)
...
class VariablesModify(chainflow_pycamunda.base.CamundaRequest):
...
class VariablesUpdate(chainflow_pycamunda.base.CamundaRequest):
