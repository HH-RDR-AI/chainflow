...
class GetList(chainflow_pycamunda.base.CamundaRequest):
    ...
    completed = QueryParameter('completed', provide=chainflow_pycamunda.base.value_is_true)
    ...
    variable_names_ignore_case = QueryParameter(
        'variableNamesIgnoreCase', provide=chainflow_pycamunda.base.value_is_true
    )
    variable_values_ignore_case = QueryParameter(
        'variableValuesIgnoreCase', provide=chainflow_pycamunda.base.value_is_true
    )
...
class _VariableDeletionMixin(chainflow_pycamunda.base.CamundaRequest):
...
class Complete(_VariableDeletionMixin, chainflow_pycamunda.base.CamundaRequest):
...
class Close(_VariableDeletionMixin, chainflow_pycamunda.base.CamundaRequest):
...
class Terminate(_VariableDeletionMixin, chainflow_pycamunda.base.CamundaRequest):
