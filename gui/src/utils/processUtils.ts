...
export const getInstances = async (id?: string): Promise<ProcessInstance[]> => {
  const res = await fetch(
    `http://0.0.0.0:3000/dashboard/api/engine/process-instance${
...
export const getDefinition = async (id: string): Promise<ProcessDefinition> => {
  const res = await fetch(
    `http://0.0.0.0:3000/dashboard/api/engine/process-definition?processDefinitionId=${id}`
  );
...
export const getInstance = async (id: string): Promise<ProcessInstance> => {
  const res = await fetch(
    `http://0.0.0.0:3000/dashboard/api/engine/process-instance/${id}`
  );
...
export const getVariables = async (id: string): Promise<ProcessVariables> => {
  const res = await fetch(
    `http://0.0.0.0:3000/dashboard/api/engine/process-instance/${id}/variables`
  );
...
export const getDefinitions = async (): Promise<ProcessDefinition[]> => {
  const res = await fetch(
    "http://0.0.0.0:3000/dashboard/api/engine/process-definition"
  );
...
export const getInstanceCount = async (id: string): Promise<number> => {
  const res = await fetch(
    `http://0.0.0.0:3000/dashboard/api/engine/process-instance/count?processDefinitionId=${id}`
  );
...
export const getTasks = async (
  ...
  const res = await fetch(
    `http://0.0.0.0:3000/dashboard/api/engine/task?${query.join("&")}`
  );
